...
| 项 | 内容 |
|---|---|
| 产品官网 | Astro 5 + Tailwind 4，FAB 三支柱架构，中英双语，GitHub Pages 自动部署 |
| 产品截图 | 4 张真实截图 + 滚动 reveal 动画 |
| README.md | V1.1 全面重写，中英双语 |
| 三端构建 CI | GitHub Actions，push `v*` tag → 4 平台构建 → GitHub Release |
| V1.1.0 发布 | tag 已推送，构建已触发 |

**日志**：`evidence/task-logs/2026-04-13-website-release.md`
...
| 4+ | ~~P2~~ | ~~根节点内容与标题优化~~ | ✅ 2026-04-11 概览面板 SectionBlock 包裹 | ✅ |
| 22 | ~~P2~~ | ~~代码文件样式对齐~~ | ✅ 2026-04-11 extra-file sectionId+color+桥线同步 | ✅ |
| 1 | ~~P3~~ | ~~架构条适配不同页面~~ | ✅ 2026-04-11 空层隐藏+箭头动态适配 | ✅ |
| 8 | ~~P3~~ | ~~i18n 补全~~ | ✅ 2026-04-11 12处硬编码+架构条i18n化+~30 key | ✅ |
| 15 | ~~P3~~ | ~~子区块标题编辑+预览同步~~ | ✅ 2026-04-11 SectionBlock onTitleChange+draftHeadings | ✅ |
| 16 | ~~P3~~ | ~~SKILL.md 编辑后校验~~ | ✅ 2026-04-11 Zod refine+保存前safeParse+按钮禁用 | ✅ |
| 17 | ~~P3~~ | ~~文档区块展开/收起~~ | ✅ 已由 SectionBlock 内置实现（caret+collapsed） | ✅ |
