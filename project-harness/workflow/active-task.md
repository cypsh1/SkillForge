...
## 状态
**进行中** — 批次 1.1 ~ 1.4 已完成，剩余 1.5 配置编辑器
...
| 批次 | 内容 | 产出 | 状态 |
|:---:|------|------|:---:|
| 1.1 | 技术选型确认 + 项目初始化 | package.json、tsconfig、构建配置 | [x] |
| 1.2 | SKILL.md 解析器 | 能解析 frontmatter + 工具定义 + 配置文件 | [x] |
| 1.3 | 基础 UI 框架 | 布局骨架、Skill 列表页 | [x] |
| 1.4 | Skill 详情页 | 展示解析后的 Skill 结构信息 | [x] |
